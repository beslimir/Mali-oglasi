...
public class Update extends AppCompatActivity implements View.OnClickListener{
    ...
    private String currentDateandTime, posCtgId, userId, myTitle, datePublished;
    int pos;
    //timer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null){
            myTitle = extras.getString("title_post");
            myUser = extras.getString("user_name");
            etTitle.setText(myTitle);
        }

        //set previously inserted data
        Cursor getPostNow = dbUpdate.getPost(myUser, myTitle);
        getPostNow.moveToFirst();
        etDetail.setText(getPostNow.getString(getPostNow.getColumnIndex("text_post")));
        etPrice.setText(getPostNow.getString(getPostNow.getColumnIndex("price")));
        tvDate.setText(getPostNow.getString(getPostNow.getColumnIndex("date_post")));
        tvTime.setText(getPostNow.getString(getPostNow.getColumnIndex("time_post")));
    }
    ...
    protected TimePickerDialog.OnTimeSetListener kTimePickerListener = new TimePickerDialog.OnTimeSetListener(){
        ...
        public void onTimeSet(TimePicker view, int hourDay, int minuteDay){
            ...
            if(hour < 10 && minute < 10){
                //Toast.makeText(Update.this, "0" + hour + ":0" + minute, //Toast.LENGTH_LONG).show();
                tvTime.setText("0" + hour + ":0" + minute);
            }
            else if(hour < 10 && minute > 9){
                //Toast.makeText(Update.this, "0" + hour + ":" + minute, //Toast.LENGTH_LONG).show();
                tvTime.setText("0" + hour + ":" + minute);
            }
            else if(hour > 9 && minute < 10){
                //Toast.makeText(Update.this, hour + ":0" + minute, //Toast.LENGTH_LONG).show();
                tvTime.setText(hour + ":0" + minute);
            }
            else{
                //Toast.makeText(Update.this, hour + ":" + minute, //Toast.LENGTH_LONG).show();
    ...
    private DatePickerDialog.OnDateSetListener dPickerListener = new DatePickerDialog.OnDateSetListener(){
        ...
        public void onDateSet(DatePicker view, int yearYear, int monthYear, int dayYear){
            ...
            if(day < 10 && month < 10){
                //Toast.makeText(Update.this, year + ".0" + month + ".0" + day, //Toast.LENGTH_LONG).show();
                tvDate.setText("0" + day + ".0" + month + "." + year + ".");
            }
            else if(day < 10 && month > 10){
                //Toast.makeText(Update.this, "0" + year + "." + month + "." + day, //Toast.LENGTH_LONG).show();
                tvDate.setText("0" + day + "." + month + "." + year + ".");
            }
            else if(day > 10 && month < 10){
                //Toast.makeText(Update.this, year + ".0" + month + "." + day, //Toast.LENGTH_LONG).show();
                tvDate.setText(day + ".0" + month + "." + year + ".");
            }
            else{
                //Toast.makeText(Update.this, year + "." + month + "." + day, //Toast.LENGTH_LONG).show();
    ...
    protected Dialog onCreateDialog(int id){
        if(id == DIALOG_ID){
            return new TimePickerDialog(Update.this, kTimePickerListener, hour, minute, true);
        }
        else if(id == DIALOG_ID2){
            return new DatePickerDialog(Update.this, dPickerListener, year, month, day);
        }
        return null;
    }
    ...
    public void onClick(View view) {
        //first, get user_name
        Cursor get_user_nameNow = dbUpdate.get_user_name();
        if(get_user_nameNow.getCount() == 0){
            //Toast.makeText(Update.this, "error user_name", //Toast.LENGTH_SHORT).show();
        }
        get_user_nameNow.moveToLast();
        String myUser = get_user_nameNow.getString(get_user_nameNow.getColumnIndex("user_name"));
        //Toast.makeText(Update.this, "Username: " + myUser, //Toast.LENGTH_SHORT).show();
        ...
        //Toast.makeText(Update.this, "Updated " + etTitle.getText().toString(), //Toast.LENGTH_SHORT).show();
        //delete previous post
        Cursor deleteIt = dbUpdate.deletePost(myUser, myTitle);
        if(deleteIt.getCount() == 0){
        ...
        /*Cursor deletePostNow = dbUpdate.updatePost(etTitle.getText().toString(),
                etDetail.getText().toString(),
                Integer.parseInt(etPrice.getText().toString()),
                tvDate.getText().toString(),
                tvTime.getText().toString(),
        ...
        if(deletePostNow.getCount() == 0){
            //Toast.makeText(Update.this, "Post deleted: " + myTitle, //Toast.LENGTH_SHORT).show();
            return;
        }else{
            deletePostNow.moveToNext();
            //Toast.makeText(Update.this, "Post not deleted...", //Toast.LENGTH_SHORT).show();
        }*/
